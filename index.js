module.exports = {
  "label": {
    "en": {
      ...
      "SELFIE_LABEL": "Upload a whole face photo while holding your ID",
      "SELFIE_DETAIL": "Before taking a photo, please have your face and ID card positioned in one screen with a bright enough light.",
      ...
      "RISK_NOT_MATCH_LABEL": "Mutual funds that you choose do not match the risk profile that you have filled, if you want to continue transaction click submit",
      ...
      "AGREEMENT_TRANSACTION": "I have read, understand the contents of the Prospectus and agree to conduct transactions with Paytren Asset Management and agree to the Terms and Conditions.",
      ...
      "DISCLAIMER_LABEL": "Investment through mutual funds carries risks, prospective investors must read and understand the prospectus before deciding to invest through mutual funds, past performance does not reflect future performance.",
      "REDEMPTION_BASED_ON_AMOUNT_LABEL": "Redemption of Participation Units by Nominal",
      "REDEMPTION_BASED_ON_UNIT_LABEL": "Redemption of Participation Units by Unit",
      "REDEMPTION_ALL_LABEL": "Redemption of Participation Unit of all Units owned",
      "PRODUCT_RISK_LABEL": "Fund Risk of the selected Fund",
      "YOUR_RISK_LABEL": "Your Risk Profile",
      "SWITCHING_BASED_ON_UNIT_LABEL": "Switching of Participation Units by Unit",
      "SWITCHING_BASED_ON_AMOUNT_LABEL": "Switching of Participation Units by Nominal",
      "NEW_LAST_NAV_LABEL": "Net Asset Value (NAV)",
      "NEW_BALANCE_LABEL": "Unit Participation Balance (UP)"
    },
    "idn": {
      "GREETING_MORNING": "",
      "GREETING_AFTERNOON": "",
      ...
      "SELFIE_LABEL": "Unggah foto seluruh wajah sambil memegang KTP Anda",
      "SELFIE_DETAIL": "Sebelum mengambil foto, mohon Wajah dan KTP anda diposisikan dalam satu layar dengan cahaya yang cukup terang dan jelas.",
      ...
      "BANK_ACCOUNT_NAME_LABEL": "Nama pemilik rekening bank",
      ...
      "RISK_NOT_MATCH_LABEL": "Reksa dana yang anda pilih tidak sesuai dengan profil risiko yang telah anda isi, jika ingin melanjutkan transaksi klik submit",
      ...
      "AGREEMENT_TRANSACTION": "Saya telah membaca, memahami isi Prospektus dan menyetujui untuk melakukan transaksi dengan paytren aset manajemen serta menyetujui Syarat dan ketentuan.",
      ...
      "DISCLAIMER_LABEL": "Investasi melalui reksa dana mengandung risiko, calon pemodal wajib membaca dan memahami prospektus sebelum memutuskan untuk berinvestasi melalui reksa dana, kinerja masa lalu tidak mencerminkan kinerja masa mendatang.",
      "REDEMPTION_BASED_ON_AMOUNT_LABEL": "Penjualan Kembali (Redemption) Unit Penyertaan berdasarkan Nominal",
      "REDEMPTION_BASED_ON_UNIT_LABEL": "Penjualan Kembali (Redemption) Unit Penyertaan  berdasarkan Unit",
      "REDEMPTION_ALL_LABEL": "Penjualan Kembali (Redemption) Unit Penyertaan semua Unit yang dimiliki",
      "PRODUCT_RISK_LABEL": "Resiko Reksa Dana yang dipilih",
      "YOUR_RISK_LABEL": "Profil Resiko Anda",
      "SWITCHING_BASED_ON_UNIT_LABEL": "Pengalihan (Switching) Unit Penyertaan  berdasarkan Unit",
      "SWITCHING_BASED_ON_AMOUNT_LABEL": "Pengalihan (Switching) Unit Penyertaan berdasarkan Nominal",
      "NEW_LAST_NAV_LABEL": "Nilai Aktiva Bersih (NAB)",
      "NEW_BALANCE_LABEL": "Saldo Unit Penyertaan (UP)"
    }
  },
  "errors": {
    "en": {
      ...
      "EMAIL_INVALID_OR_LOGIN": "That email address is already taken please choose another one or back to login page",
    ...
    "idn": {
      ...
      "EMAIL_INVALID": "Alamat email sudah terdaftar silahkan pilih yang lain",
      "EMAIL_INVALID_OR_LOGIN": "Alamat email sudah terdaftar silahkan pilih yang lain atau kembali ke halaman login",
